...
if (jspb.Message.GENERATE_TO_OBJECT) {
  ...
  proto.Person.toObject = function(includeInstance, msg) {
    var obj = {
      ...
      scoreList: jspb.Message.getRepeatedField(msg, 2)
    };
 ...
 * @return {!Array<number>}
 */
proto.Person.prototype.getScoreList = function() {
  return /** @type {!Array<number>} */ (jspb.Message.getRepeatedField(this, 2));
};

/** @param {!Array<number>} value */
proto.Person.prototype.setScoreList = function(value) {
 ...
 */
proto.Person.prototype.addScore = function(value, opt_index) {
 ...
 */
proto.Person.prototype.clearScoreList = function() {
  this.setScoreList([]);
};
